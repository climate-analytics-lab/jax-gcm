...
The v2.0 ECHAM T63L47 hybrid + RRTMGP stack is the Python equivalent of
...
# T63L47 hybrid sigma-pressure coordinates. get_echam_levels(47) returns the
# dinosaur HybridCoordinates table (a-boundaries in Pa); get_coords wraps it
