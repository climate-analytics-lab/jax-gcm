...
| PI oxidant climatology | `.../trop_mozart_aero/oxid/oxid_1.9x2.5_L26_1850clim_c091123.nc` (or 1850s mean of the transient file) | 1.9×2.5°, L26 |

Surveyed and ruled out: `/glade/campaign/acom/acom-climate/cesm2/inputdata/atm/waccm/`
— the SC-WACCM forcing files (L70, lid ~6e-6 hPa) carry O3/O/O2/H/NO/CO2 +
heating but **no OH/NO3/H2O2**, and `sulf/` is stratospheric sulfate SAD.
No high-lid sulfur-oxidant product exists on Glade; oxidants stay L26.
