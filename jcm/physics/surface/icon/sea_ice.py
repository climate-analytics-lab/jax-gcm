"""Sea-ice diagnostic fluxes for the ICON multi-tile surface scheme.
...
the ICON flow prescribes ice fraction and ice surface temperature from
...
def sea_ice_physics_step(
    ...
    the boundary forcing in the ICON flow, so this step returns zero
