"""Ocean surface diagnostic fluxes for the ICON multi-tile surface scheme.
...
SST) in ICON's flow, so this module computes diagnostic fluxes only and
...
def ocean_physics_step(
    ...
    Ocean temperature is prescribed by the boundary SST in the ICON flow,
