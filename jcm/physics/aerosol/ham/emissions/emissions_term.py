"""``HamEmissions`` — online natural + prescribed aerosol surface sources.
...
from jcm.physics.aerosol.ham.emissions.distributors import distribute_surface_flux
...
class HamEmissions(PhysicsTerm):
