# ICON Physics Implementation Roadmap

This document outlines the path from the current JAX ICON physics implementation to a fully-functioning replica of the original Fortran code in `../icon_plumeworld/src/atm_phy_echam/`.
...
- **Files:** `icon_physics.py`, `vertical_diffusion/`
...
- **Files:** `icon_physics.py`, `vertical_diffusion/turbulence_coefficients.py`
