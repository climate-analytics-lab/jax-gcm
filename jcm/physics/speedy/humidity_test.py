...
class TestHumidityUnit(unittest.TestCase):
    ...
    def setUp(self):
        ...
        SurfaceFluxData, HumidityData, SWRadiationData, LWRadiationData, parameters, BoundaryData, geometry_raw
    ...
    def test_spec_hum_to_rel_hum_isnan_ones(self):
        ...
        geometry = geometry_raw.set_orography(phi0/grav, get_coords().horizontal)
        ...
        _, f_vjp = jax.vjp(spec_hum_to_rel_hum, state, physics_data, parameters, boundaries, geometry) 
    ...
    def test_spec_hum_to_rel_hum(self):
        ...
        _, physics_data = spec_hum_to_rel_hum(physics_data=physics_data, state=state, parameters=parameters, boundaries=boundaries, geometry=geometry_raw)
    ...
    def test_rel_hum_to_spec_hum(self):
        ...
        _, physics_data = spec_hum_to_rel_hum(physics_data=physics_data, state=state, parameters=parameters, boundaries=boundaries, geometry=geometry_raw)
        qa, qsat = rel_hum_to_spec_hum(temp[0], pressure, geometry_raw.fsg[0], physics_data.humidity.rh[0])
