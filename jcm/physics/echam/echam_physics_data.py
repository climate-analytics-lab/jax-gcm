"""Physics data structures for ECHAM atmospheric physics

This module defines the data structures that hold state and diagnostics
for ECHAM physics parameterizations, following the SpeedyPhysics pattern.
...
class CloudData:
    ...
    # by the physics-data pass-through in ComposableEchamPhysics so the 2M
...
@tree_math.struct
class PhysicsData:
    """Main physics data container for ECHAM physics"""
    ...
    @classmethod
    def zeros(cls, nodal_shape, nlev, echam_coords=None, model_step=None, dt_seconds=None):
        return cls(
    ...
    def copy(self, **kwargs):
        new_data = {
            ...
            'echam_coords': self.echam_coords,
