"""ECHAM Atmospheric Physics Package for JAX-GCM

This package contains JAX implementations of the ECHAM atmospheric physics
parameterizations (as adapted from ICON's `atm_phy_echam`), originally
written in Fortran. The modules are organized by physics category and
follow the same structure as the SPEEDY physics implementation.
