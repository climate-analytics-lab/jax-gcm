...
def _initialize_vertical(kx):
    ...
    This helper function defines the model's vertical structure based on
    pre-defined sigma coordinates. It calculates layer boundaries, midpoints,
    thicknesses, and various factors used in the physics parameterizations.
...
class Geometry:
    ...
    This class holds pre-computed arrays related to the model's horizontal and
    vertical grid. It is registered as a JAX PyTree, allowing it to be used
    seamlessly with JAX transformations.
    ...
    Attributes:
        ...
        grdsig (jnp.ndarray): Conversion factor g / (d_sigma * p0) used to
            convert momentum and moisture fluxes into tendencies (d/dt).
