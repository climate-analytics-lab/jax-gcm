...
class TestSolar(unittest.TestCase):
    ...
    def test_solar(self):
        ...
        self.assertTrue(jnp.allclose(solar(0.2), jnp.array([
        ...
        self.assertTrue(jnp.allclose(solar(0.4), jnp.array([
        ...
        self.assertTrue(jnp.allclose(solar(0.6), jnp.array([
        ...
        self.assertTrue(jnp.allclose(solar(0.8), jnp.array([
        ...
        self.assertTrue(jnp.allclose(solar(1.0), jnp.array([
        ...
        # other csol values
        self.assertTrue(jnp.allclose(solar(0.6, 1300), jnp.array([
            0.,          0.,           0.,           0.,
...
class TestShortWaveRadiation(unittest.TestCase):
    ...
    def test_shortwave_radiation(self):
        ...
        self.assertTrue(jnp.allclose(physics_data.shortwave_rad.rsds[0, :], [
        ...
        self.assertTrue(jnp.allclose(physics_data.shortwave_rad.ssr[0, :], [
            0., 0., 0., 0., 1.08102491, 7.9856262, 17.54767508, 28.67351887, 40.8631746, 53.79605732,
            67.22801389, 80.95422179, 94.79448489, 108.58701854, 122.18603817, 135.46087123, 148.29548103,
            160.58828119, 172.25138545, 183.21006299, 193.40177528, 202.77492961, 211.28786499, 218.90753726,
            225.60832278, 231.37096758, 236.18142325, 240.03003908, 242.91081466, 244.82085417, 245.76014002,
        ...
        self.assertTrue(jnp.allclose(physics_data.shortwave_rad.ftop[0, :], [
        ...
        self.assertTrue(jnp.allclose(jnp.mean(physics_data.shortwave_rad.dfabs, axis=2)[0, :], [
        ...
        self.assertTrue(jnp.allclose(jnp.mean(physics_data.shortwave_rad.dfabs, axis=1)[0, :], [
