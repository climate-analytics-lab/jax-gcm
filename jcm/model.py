...
class Model:
    ...
    def __init__(self, time_step=30.0, geometry: Geometry=None, coords: CoordinateSystem=None,
        ...
        def make_diffusion_fn(timescale: jnp.float_, order: jnp.int_, replace_fn):
            '''
        ...
        diffuse_vor_q = make_diffusion_fn(
        ...
        diffuse_temp = make_diffusion_fn(
