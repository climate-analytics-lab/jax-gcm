...
class SingleColumnModel:
    """
    A single column model that uses the Speedy physics on an aquaplanet.
    This is a simplified version of the Model class, focusing on a single column of the atmosphere.
    """
