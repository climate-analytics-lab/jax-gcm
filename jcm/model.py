...
def get_speedy_physics_terms(grid_shape, sea_coupling_flag=0, coords=None):
    """
...
class SpeedyModel:
    ...
    def __init__(self, time_step=10, save_interval=10, total_time=1200, layers=8, 
        ...
        self.physics_terms = get_speedy_physics_terms(self.coords.nodal_shape, coords=self.coords)
