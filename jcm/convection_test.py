...
class TestConvectionUnit(unittest.TestCase):
    ...
    def test_get_convective_tendencies_moist_adiabat(self):
        ...
        self.assertAlmostEqual(dfse[0,0,4], test_dfse[4], places=2)
        self.assertAlmostEqual(dfqa[0,0,4], test_dfqa[4], places=2) 
        self.assertAlmostEqual(dfse[0,0,5], test_dfse[5], places=2)
        self.assertAlmostEqual(dfqa[0,0,5], test_dfqa[5], places=2) 
        self.assertAlmostEqual(dfse[0,0,6], test_dfse[6], places=2)
        self.assertAlmostEqual(dfqa[0,0,6], test_dfqa[6], places=2) 
